# 1 "Lib_mias_all/microchip_LCD/wcmdxlcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Lib_mias_all/microchip_LCD/wcmdxlcd.c" 2
...
# 2 "Lib_mias_all/microchip_LCD/wcmdxlcd.c" 2
# 13 "Lib_mias_all/microchip_LCD/wcmdxlcd.c"
void WriteCmdXLCD(unsigned char cmd)
{
# 32 "Lib_mias_all/microchip_LCD/wcmdxlcd.c"
        TRISB &= 0xf0;
        PORTB &= 0xf0;
        PORTB |= (cmd>>4)&0x0f;
