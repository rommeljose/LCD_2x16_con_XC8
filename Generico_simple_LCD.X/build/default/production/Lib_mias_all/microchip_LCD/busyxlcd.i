# 1 "Lib_mias_all/microchip_LCD/busyxlcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Lib_mias_all/microchip_LCD/busyxlcd.c" 2
...
# 2 "Lib_mias_all/microchip_LCD/busyxlcd.c" 2
# 11 "Lib_mias_all/microchip_LCD/busyxlcd.c"
unsigned char BusyXLCD(void)
{
        LATBbits.LATB5 = 1;
        LATCbits.LATC0 = 0;
        ...
        LATBbits.LATB6 = 1;
        DelayFor18TCY();
# 35 "Lib_mias_all/microchip_LCD/busyxlcd.c"
        if(PORTB&0x08)
