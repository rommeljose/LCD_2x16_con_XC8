# 1 "Lib_mias_all/microchip_LCD/putrxlcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Lib_mias_all/microchip_LCD/putrxlcd.c" 2
...
# 2 "Lib_mias_all/microchip_LCD/putrxlcd.c" 2
# 16 "Lib_mias_all/microchip_LCD/putrxlcd.c"
