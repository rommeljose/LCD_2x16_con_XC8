# 1 "Lib_mias_all/microchip_LCD/readaddr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Lib_mias_all/microchip_LCD/readaddr.c" 2
...
# 2 "Lib_mias_all/microchip_LCD/readaddr.c" 2
# 16 "Lib_mias_all/microchip_LCD/readaddr.c"
unsigned char ReadAddrXLCD(void)
{
        char data;
# 30 "Lib_mias_all/microchip_LCD/readaddr.c"
        LATBbits.LATB5 = 1;
        LATCbits.LATC0 = 0;
        DelayFor18TCY();
        LATBbits.LATB6 = 1;
