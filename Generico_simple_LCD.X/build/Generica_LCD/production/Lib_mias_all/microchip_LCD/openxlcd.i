# 1 "Lib_mias_all/microchip_LCD/openxlcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Lib_mias_all/microchip_LCD/openxlcd.c" 2
...
# 3 "Lib_mias_all/microchip_LCD/openxlcd.c" 2

# 1 "Lib_mias_all/microchip_LCD/./../../mcc_generated_files/device_config.h" 1
# 4 "Lib_mias_all/microchip_LCD/openxlcd.c" 2
# 20 "Lib_mias_all/microchip_LCD/openxlcd.c"
void OpenXLCD(unsigned char lcdtype)
{
# 32 "Lib_mias_all/microchip_LCD/openxlcd.c"
        PORTB &= 0xf0;
        TRISB &= 0xF0;
